...
{
    public partial class OneOfThreeForm : Form
    {
        private int index;
        ...
        public OneOfThreeForm()
        {
            InitializeComponent();
        }

        public OneOfThreeForm(Random rnd, bool sound)
        {
            this.rnd = rnd;
            this.sound = sound;
            ...
            pictureBox1.BackColor = ColorInfo.listOfColors[indexes[0]];
            pictureBox2.BackColor = ColorInfo.listOfColors[indexes[1]];
            pictureBox3.BackColor = ColorInfo.listOfColors[indexes[2]];
        ...
        private void OneOfThreeForm_Load(object sender, EventArgs e)
        {
            this.KeyPreview = true;
        }

        private void OneOfThreeForm_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            Help.ShowHelp(this, "help\\one-of-three.html");
        }
    }
}
